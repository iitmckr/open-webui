						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use akritrim® Intelligence™ and seek support from the community.')}
								</div>
							</div>

							<a
								class="flex-shrink-0 text-xs font-medium underline"
								href="https://docs.akritrim.com/"
								target="_blank"
							>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="https://discord.gg/5rJgQTnV4s" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Discord-akritrim®_Intelligence™-blue?logo=discord&logoColor=white"
									/>
								</a>

								<a href="https://twitter.com/akritrim" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/akritrim"
									/>
								</a>

								<a href="https://github.com/akritrim/akritrim" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/akritrim/akritrim?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://docs.akritrim.com/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEY_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.akritrim.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.akritrim.com/getting-started/api-endpoints"
										target="_blank"
